                    ...
                    if(preg_match("/^\d+(?:[.,]\d+)?$/",$taille)){
                        if(preg_match("/^[a-zA-Z-']*$/",$poste)){
                            ...
                            // *********************** import img *********************
                                ...
                                $request=$pdo->prepare("INSERT INTO test(nom,nationalite,age,taille,poste,email,photo) VALUES (?,?,?,?,?,?,?)");
                                $request->execute([$nom, $nationalite, $age, $taille, $poste, $email, $file_dest]);
                        ...
                        echo"la taille n'a pas été renseigné";
                    }
